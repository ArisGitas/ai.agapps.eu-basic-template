    ...
    <section id="contact" data-section="cta" data-agapps-id="homepage-cta-container" className="bg-[#0070f3] py-20">
      <Container>
        <div className="text-center">
          <h2 data-role="title" data-agapps-id="homepage-cta-title" className="text-3xl font-bold text-white mb-4">
            {t("cta.title")}
          </h2>
          <p data-role="subtitle" data-agapps-id="homepage-cta-subtitle" className="text-blue-100 max-w-xl mx-auto mb-10">
            {t("cta.subtitle")}
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              data-agapps-id="homepage-cta-email-link"
            ...
            <a
              ...
              data-agapps-id="homepage-cta-phone-link"
