    ...
    <section id="services" data-section="services" className="bg-gray-50 py-20">
      <Container>
        <div className="text-center mb-12">
          <h2 data-role="title" className="text-3xl font-bold text-gray-900 mb-4">{t("services.title")}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {services.map((service) => (
            ...
            >
              ...
              <h3 data-role="item-title" className="text-lg font-semibold text-gray-900 mb-2">{t(service.titleKey)}</h3>
              <p data-role="item-description" className="text-gray-500 text-sm leading-relaxed">{t(service.descKey)}</p>
            </div>
          ))}
        </div>
      </Container>
